        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
              ...
              <p className="sub-title">
                ...
                <br />
                Dsn. Bantardawa, RT 01 RW 01, Desa Rejasari, Kec. Langensari <br />
                Kota Banjar, 46344
              </p>
            </div>
          </div>
          <div className="row">
            <div className="col-md-10 col-md-offset-1">
              <iframe
                src="https://maps.google.com/maps?q=-7.348500, 108.604488&z=17&output=embed"
                width="100%"
                height="450"
                style={{ border: '0' }}
                allowFullScreen
                aria-hidden="false"
                tabIndex="0"
                title="Google Maps - Ikbal & Novi Wedding Party"
              ></iframe>
              {/* <iframe
